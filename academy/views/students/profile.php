				...
				<div id="nav-scroll">
						<div class="avatar-slide">
								...
								<div class="avatar-detail">
										<p><strong>Hi</strong>, Bello Joseph</p>
		...
		<div id="main">
										...
										<section class="profile-cover">
												<div class="profile-avatar">
														<div>
															...
															<span>Bello Joseph</span>
														</div>
														<a class="btn btn-theme" title="Add friends"><i class="fa fa-file"></i> Adminision Status: </a>
														<a class="btn btn-theme-inverse" ><i class="fa fa-money"></i> Payment Status: </a>
												</div>
												<div class="profile-status">
														<a class="btn btn-theme" title="Add friends"><i class="fa fa-file"></i> Pay Registration Fee </a>
												</div>
										</section>
								</div>
				...
				<div class="tabbable">
						<ul id="profile-tab" class="nav nav-tabs" data-provide="tabdrop">
								...
								<li class="active"><a href="#tab1" data-toggle="tab">Course Applied</a></li>
								<li><a href="#tab2" data-toggle="tab" class="timeline-show">Projects Uploaded</a></li>
										...
										<div class="tab-pane fade in active col-lg-8" id="tab1">
												...
												<div class="comment">
														...
														<div class="reply">
																<img alt="" src="assets/img/avatar5.png" class="circle">
																<div class="comment-content">
																		<p class="author"><strong>Bello Chai</strong> - 13 minutes ago</p>
										...
										<div class="col-lg-4">
																...
																<div class="well corner-flip flip-gray flip-bg-white bg-palevioletred-darken">
																		<div class="row">
																				<div class="col-xs-12 col-md-6 text-center">
																						<h1 class="rating-num"> Pay Registration Fee Here</h1>
												...
												<div class="widget-friend">
														<ul class="circle">
																...
																<li class="online" title="zicdemo"><img alt="" src="../../web/images/avatar.png"></li>
